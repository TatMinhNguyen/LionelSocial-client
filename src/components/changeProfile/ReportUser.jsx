        ...
        <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg w-full max-w-lg max-h-[90vh]">
                <div className="flex justify-between items-center border-b p-4">
                    <h3 className="text-xl font-bold flex-1 flex items-center justify-center">Report profile</h3>
                ...
                <div className='py-2 px-2'>
                    ...
                    <div className="flex flex-col">
                        <label className="flex items-center justify-between my-0.5 py-2 px-2 rounded-md hover:bg-gray-200 cursor-pointer">
                            <span className='text-[17px] font-medium'>Pretending to be someone</span>
                            <input
                                type="radio"
                                value="1"
                                checked={type === 1}
                        ...
                        <label className="flex items-center justify-between my-0.5 py-2 px-2 rounded-md hover:bg-gray-200 cursor-pointer">
                            <span className='text-[17px] font-medium'>Fake account</span>
                            <input
                                type="radio"
                                value="2"
                                checked={type === 2}
                        ...
                        <label className="flex items-center justify-between my-0.5 py-2 px-2 rounded-md hover:bg-gray-200 cursor-pointer">
                            <span className='text-[17px] font-medium'>Fake name</span>
                            <input
                                type="radio"
                                value="3"
                                checked={type === 3}
                        ...
                        <label className="flex items-center justify-between my-0.5 py-2 px-2 rounded-md hover:bg-gray-200 cursor-pointer">
                            <span className='text-[17px] font-medium'>Posting inappropriate things</span>
                            <input
                                type="radio"
                                value="4"
                                checked={type === 4}
                        ...
                        <label className="flex items-center justify-between my-0.5 py-2 px-2 rounded-md hover:bg-gray-200 cursor-pointer">
                            <span className='text-[17px] font-medium'>Harassment or bullying</span>
                            <input
                                type="radio"
                                value="5"
                                checked={type === 5}
                        ...
                        <label className="flex items-center justify-between my-0.5 py-2 px-2 rounded-md hover:bg-gray-200 cursor-pointer">
                            <span className='text-[17px] font-medium'>I just don't like it</span>
                            <input
                                type="radio"
                                value="7"
                                checked={type === 7}
