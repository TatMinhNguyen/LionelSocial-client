...
import { editPhoto, getAGroup } from '../../api/group/group';
import LoadingSpinner from '../spinner/LoadingSpinner';
import { useNavigate } from 'react-router-dom';

const ChangePhoto = ({isCloseModal, avatar, user, groupId}) => {
    ...
    const handleChangeAvatar = async(e) => {
        ...
        try {
            ...
            await editPhoto(user?.token, groupId, formData, navigate)
    ...
    <div className='fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50'>
        <div className='bg-white rounded-lg shadow-lg w-full max-w-lg max-h-[90vh]'>
            ...
            <div className='px-4 py-3'>
                ...
                <div className='mx-10 mt-4 flex-1 flex items-center justify-center relative'>                  
                    <img
                        src={imagePreview}
                        alt='Avatar'
                        className='w-full h-52 object-cover rounded-md opacity-70'
                    />  
