        ...
        <div className='h-full pt-16 flex'>
            <div className='w-1/4 bg-white fixed h-full -mt-3 shadow-2xl px-2 py-4'>
                ...
                <div className='mt-3'>
                    ...
                    <div className={`flex items-center px-2 py-2 rounded-md mb-1 cursor-pointer ${location.pathname === `/admin/banned-users` ? 'bg-blue-100 hover:bg-blue-200' : 'hover:bg-gray-200'}`}
                        onClick={() => navigate(`/admin/banned-users`)}
                    >
                        {location.pathname === `/admin/banned-users` ? (
                            <img className='w-5 h-5'
                                src={require('../../assets/icons/ban-user-blue.png')}
                                alt=''
                            />
                        ) : (
                            <img className='w-5 h-5'
                                src={require('../../assets/icons/ban-user.png')}
                                alt=''
                            />
                        )}
                        <p className={`ml-3 text-[16px] font-medium ${location.pathname === `/admin/banned-users` ? 'text-customBlue' : ''}`}>
                            Banned users 
                        </p>
                    </div>
